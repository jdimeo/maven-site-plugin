...
public class SiteMojo extends AbstractSiteRenderingMojo {
    ...
    private void renderLocale(
        ...
        getLog().info("Locating documents to render...");
        ...
        getLog().info("Rendering Doxia documents...");
        ...
        getLog().info("Rendering other documents...");
    ...
    private List<DocumentRenderer> renderDoxiaDocuments(
        ...
        if (doxiaDocuments.size() > 0) {
            ...
            Iterators.partition(doxiaDocuments.values().iterator(), procs).forEachRemaining(batch -> {
