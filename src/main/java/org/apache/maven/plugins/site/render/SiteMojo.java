...
public class SiteMojo extends AbstractSiteRenderingMojo {
    ...
    private void renderLocale(
        ...
        getLog().info(LocalDateTime.now() + " Locating documents to render...");
        Map<String, DocumentRenderer> documents = locateDocuments(context, reports, locale);

        // copy resources
        getLog().info(LocalDateTime.now() + " Copying resources...");
        siteRenderer.copyResources(context, outputDirectory);

        // 1. render Doxia documents first
        getLog().info(LocalDateTime.now() + " Rendering Doxia documents...");
        ...
        getLog().info(LocalDateTime.now() + " Rendering other documents...");
        ...
        getLog().info(LocalDateTime.now() + " Copying resources again...");
        siteRenderer.copyResources(context, outputDirectory);
        getLog().info(LocalDateTime.now() + " Done.");
    }
